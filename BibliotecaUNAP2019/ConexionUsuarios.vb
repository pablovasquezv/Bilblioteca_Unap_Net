...
Module ConexionUsuarios
    ...
    Sub Cargar_TablaUsuarios(ByVal Sql As String, ByVal Tabla As DataGridView)
    ...
    Sub Operaciones_Usuario(ByVal sql As String, ByVal imagen As PictureBox)
