...
Module ConexionPaises
    ...
    Sub Cargar_TablaPaises(ByVal Sql As String, ByVal Tabla As DataGridView)
    ...
    Sub Operaciones_Pais(ByVal sql As String, ByVal imagen As PictureBox)
