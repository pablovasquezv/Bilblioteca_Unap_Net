...
Module ConexionEditoriales
    ...
    Sub Cargar_TablaEditoriales(ByVal Sql As String, ByVal Tabla As DataGridView)
    ...
    Sub Operaciones_Editoriales(ByVal sql As String, ByVal imagen As PictureBox)
