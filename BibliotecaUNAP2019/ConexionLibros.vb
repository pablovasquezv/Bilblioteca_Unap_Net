...
Module ConexionLibros
    ...
    Sub Cargar_TablaLibros(ByVal Sql As String, ByVal Tabla As DataGridView)
    ...
    Sub Operaciones_Libros(ByVal sql As String, ByVal imagen As PictureBox)
