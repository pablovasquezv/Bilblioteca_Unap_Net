...
Module ConexionCategorias
    ...
    Sub Cargar_TablaCategorias(ByVal Sql As String, ByVal Tabla As DataGridView)
    ...
    Sub Operaciones_Categorias(ByVal sql As String, ByVal imagen As PictureBox)
