...
Module ConexionAutores
    ...
    Sub Cargar_TablaAutores(ByVal Sql As String, ByVal Tabla As DataGridView)
    ...
    Sub Operaciones_Autores(ByVal sql As String, ByVal imagen As PictureBox)
